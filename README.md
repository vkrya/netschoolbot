...
### Общий чекер
Отдельный мониторинг «в группу»: контрольные, самостоятельные и лабораторные
всего класса в общий чат/топик. Настраивается через `NETSCHOOL_*` в `.env`.
...
- `NETSCHOOL_URL/LOGIN/PASSWORD/SCHOOL` + `NETSCHOOL_CHAT_ID` — общий чекер в группу
